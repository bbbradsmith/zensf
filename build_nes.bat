...
del out_build\pico3.nes
del out_build\pico3.dbg
del out_build\pico3.map.txt
...
REM link pico3.nes
cc65\bin\ld65 -o out_build\pico3.nes -C nes.cfg -m out_build\pico3.map.txt --dbgfile out_build\pico3.dbg out_build\ramp.o out_build\base.o out_build\region.o out_build\custom.o
@IF ERRORLEVEL 1 GOTO badbuild
