...
del out_build\pico2.nes
del out_build\pico2.dbg
del out_build\pico2.map.txt
...
REM link pico2.nes
cc65\bin\ld65 -o out_build\pico2.nes -C nes.cfg -m out_build\pico2.map.txt --dbgfile out_build\pico2.dbg out_build\ramp.o out_build\base.o out_build\region.o out_build\custom.o
@IF ERRORLEVEL 1 GOTO badbuild
