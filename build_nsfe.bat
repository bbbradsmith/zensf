...
del out_build\pico2.nsfe
del out_build\pico2.nsfe.dbg
del out_build\pico2.nsfe.map.txt
...
REM link pico2.nsfe
cc65\bin\ld65 -o out_build\pico2.nsfe -C nsfe.cfg -m out_build\pico2.nsfe.map.txt --dbgfile out_build\pico2.nsfe.dbg out_build\ramp.o out_build\nsf.o out_build\nsfe.o
@IF ERRORLEVEL 1 GOTO badbuild
