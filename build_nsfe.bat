...
del out_build\zensf.nsfe
del out_build\zensf.nsfe.dbg
del out_build\zensf.nsfe.map.txt
...
REM link zensf.nsfe
cc65\bin\ld65 -o out_build\zensf.nsfe -C nsfe.cfg -m out_build\zensf.nsfe.map.txt --dbgfile out_build\zensf.nsfe.dbg out_build\ramp.o out_build\nsf.o out_build\nsfe.o
@IF ERRORLEVEL 1 GOTO badbuild
